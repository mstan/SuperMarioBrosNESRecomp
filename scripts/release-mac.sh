...
REPO_NAME="SuperMarioBrosNESRecomp"      # GitHub repo / zip basename
APP_NAME="Super Mario Bros"        # .app display name (may contain spaces)
TARGET="SuperMarioBrosRecomp"            # cmake target == built binary filename in build-mac/
SYSTEM="nes"            # nes | snes | genesis | vb | psx
VERSION="v1.4.0-macos"          # release tag, e.g. v0.1.0-macos
ROM_HINT="Super Mario Bros. (USA/Japan) .nes dump"        # human description of the ROM the user must supply
# ==============================================
